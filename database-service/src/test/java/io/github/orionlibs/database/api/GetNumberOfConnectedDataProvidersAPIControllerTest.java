...
@ActiveProfiles("test")
class GetNumberOfConnectedDataProvidersAPIControllerTest
{
    ...
    public void setUp()
    {
        basePath = "http://localhost:" + port + ControllerUtils.baseAPIPath + "/databases/connected/count";
    }
    ...
    void getNumberOfConnectedDataProviders()
    {
        ...
        assertThat(body.get("number_of_connected_data_providers")).isEqualTo(0);
    }
}
