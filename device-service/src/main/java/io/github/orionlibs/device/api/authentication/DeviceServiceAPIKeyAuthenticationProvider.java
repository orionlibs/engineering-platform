package io.github.orionlibs.device.api.authentication;
...
@Component
public class DeviceServiceAPIKeyAuthenticationProvider implements AuthenticationProvider
{
    @Autowired private DeviceServiceAPIKeyValidationService validationService;
