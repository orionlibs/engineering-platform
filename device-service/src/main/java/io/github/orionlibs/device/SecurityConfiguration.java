...
import io.github.orionlibs.device.api.authentication.DeviceServiceAPIKeyAuthenticationProvider;
...
public class SecurityConfiguration
{
    ...
    @Bean
    public AuthenticationManager apiKeyAuthenticationManager(DeviceServiceAPIKeyAuthenticationProvider apiKeyProvider)
    {
    ...
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtDecoder jwtDecoder, JwtAuthenticationConverter authConverter, DeviceServiceAPIKeyAuthenticationProvider apiKeyProvider, ApiKeyAuthFilter apiKeyAuthFilter) throws Exception
    {
