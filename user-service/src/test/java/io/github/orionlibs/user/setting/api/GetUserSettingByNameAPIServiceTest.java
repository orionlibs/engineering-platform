...
@ActiveProfiles("test")
public class GetUserSettingByNameAPIServiceTest
{
    ...
    void setup()
    {
        basePath = "http://localhost:" + port + ControllerUtils.baseAPIPath + "/users/settings/names/%s";
        dao.deleteAll();
    ...
    @Test
    void getUserSettingByName()
    {
        RestAssured.baseURI = String.format(basePath, "theme");
