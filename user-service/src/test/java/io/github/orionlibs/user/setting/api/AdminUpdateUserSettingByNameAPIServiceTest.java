...
@ActiveProfiles("test")
public class AdminUpdateUserSettingByNameAPIServiceTest
{
    ...
    @Test
    void adminUpdateUserSettingByName()
    {
        RestAssured.baseURI = String.format(basePath, user.getId().toString(), "theme");
        AdminUpdateUserSettingByNameRequest request = AdminUpdateUserSettingByNameRequest.builder()
                        .settingValue("light")
                        .build();
