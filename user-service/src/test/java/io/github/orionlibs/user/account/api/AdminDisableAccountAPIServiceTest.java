...
@ActiveProfiles("test")
public class AdminDisableAccountAPIServiceTest
{
    ...
    void setup()
    {
        basePath = "http://localhost:" + port + ControllerUtils.baseAPIPath + "/admin/users/disablements";
        dao.deleteAll();
    ...
    @Test
    void adminDisableAccount_userNotFound()
    {
        RestAssured.baseURI = basePath;
        AdminEnableAccountRequest request = AdminEnableAccountRequest.builder()
    ...
    @Test
    void adminDisableAccount_invalidUserID()
    {
        RestAssured.baseURI = basePath;
        AdminEnableAccountRequest request = AdminEnableAccountRequest.builder()
                        .userID("invalidUUID")
