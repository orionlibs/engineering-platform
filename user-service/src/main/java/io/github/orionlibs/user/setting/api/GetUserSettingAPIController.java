...
public class GetUserSettingAPIController extends WebService
{
    ...
    public ResponseEntity<UserSettingDTO> getUserSetting(@PathVariable String settingsID, HttpServletRequest request)
    {
        Optional<UserSettingsModel> userSetting = userSettingsService.getByIDAndUserID(settingsID, getUserID(request));
