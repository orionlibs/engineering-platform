...
public class AdminGetUserSettingAPIController extends WebService
{
    @Autowired
    ...
    @Operation(
                    ...
                    parameters = {@io.swagger.v3.oas.annotations.Parameter(
                                    ...
                                    name = "settingsID",
                                    description = "The settingsID to retrieve",
                                    required = true,
                                    in = ParameterIn.PATH,
                                    schema = @Schema(type = "string")
                    )},
    ...
    {
        Optional<UserSettingsModel> userSetting = userSettingsService.getByIDAndUserID(settingsID, userID);
