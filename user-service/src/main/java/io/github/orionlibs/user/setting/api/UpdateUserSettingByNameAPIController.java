...
public class UpdateUserSettingByNameAPIController extends WebService
{
    @Autowired
    ...
    public ResponseEntity<?> updateUserSettingByName(@PathVariable String settingName, @Valid @RequestBody UpdateUserSettingByNameRequest requestBean, HttpServletRequest request)
    {
        userSettingsService.updateByName(settingName, requestBean.getSettingValue(), getUserID(request));
