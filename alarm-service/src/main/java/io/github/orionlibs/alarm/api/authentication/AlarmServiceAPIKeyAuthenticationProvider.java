...
@Component
public class AlarmServiceAPIKeyAuthenticationProvider implements AuthenticationProvider
{
    @Autowired private AlarmServiceAPIKeyValidationService validationService;
