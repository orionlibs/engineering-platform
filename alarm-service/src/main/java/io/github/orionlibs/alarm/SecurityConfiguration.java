...
import io.github.orionlibs.alarm.api.authentication.AlarmServiceAPIKeyAuthenticationProvider;
...
public class SecurityConfiguration
{
    ...
    @Bean
    public AuthenticationManager apiKeyAuthenticationManager(AlarmServiceAPIKeyAuthenticationProvider apiKeyProvider)
    {
    ...
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtDecoder jwtDecoder, JwtAuthenticationConverter authConverter, AlarmServiceAPIKeyAuthenticationProvider apiKeyProvider, ApiKeyAuthFilter apiKeyAuthFilter) throws Exception
    {
