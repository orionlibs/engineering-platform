...
@ActiveProfiles("test")
public class GetNumberOfDisabledAlarmsAPIControllerTest
{
    ...
    public void setUp()
    {
        ...
        RestAssured.baseURI = "http://localhost:" + port + ControllerUtils.baseAPIPath + "/alarms/disabled/count";
    }
    ...
    void getNumberOfDisabledAlarms()
    {
        ...
        assertThat(body.get("number_of_disabled_alarms")).isEqualTo(1);
    }
}
