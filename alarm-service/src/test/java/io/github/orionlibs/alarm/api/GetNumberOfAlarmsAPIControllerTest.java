...
@ActiveProfiles("test")
public class GetNumberOfAlarmsAPIControllerTest
{
    ...
    public void setUp()
    {
        ...
        RestAssured.baseURI = "http://localhost:" + port + ControllerUtils.baseAPIPath + "/alarms/count";
    }
    ...
    void getNumberOfAlarms()
    {
        ...
        assertThat(body.get("number_of_alarms")).isEqualTo(2);
    }
}
